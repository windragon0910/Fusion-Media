...
import CustomCalendlyButton from "./CustomCalendlyButton.jsx";
        ...
        <div className="grid grid-cols-4 pb-8">
          ...
          <div className="col-span-4 pb-6 md:col-span-2">
            <div className="flex max-w-[460px] flex-col ">
              ...
              <p className="text-xs font-normal text-[#4D5761] mb-4">
                You can contact us via email at: support@fusionmda.com"
              </p>
          ...
          <div className="col-span-4 flex flex-row gap-x-8 md:col-span-2">
            <div className="flex md:w-1/2 ">
              <div className="flex flex-col ">
                ...
                <div className="font-normal text-[#6B7280]">Sydney, Australia</div>
              </div>
            </div>
            <div className="md:w-1/2">
              <p className="my-2 font-semibold">Contact</p>
              <p className="font-normal text-[#6B7280]">
                Email:support@fusionmda.com
              </p>
            </div>
          </div>
        </div>
